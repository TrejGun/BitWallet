...
export default class BuyEtherWidget extends Component {
      ...
      case OPTION_VALUES.QR_CODE:
        return (
          <div className="buy-ether__action-content-wrapper">
            ...
            <div className="buy-ether__small-body-text">(This is the account address that MetaMask created for you to recieve funds.)
            </div>
            <div className="buy-ether__buttons">
              <Button
                bsStyle="primary"

...
import ShapeShiftForm from "../../shapeshift-form/index";
import Identicon from "../../../../../ui/app/components/identicon";
import {Button} from "react-bootstrap";
import {FormattedMessage} from "react-intl";
import CopyButton from "../../../../../ui/app/components/copy/copy-button";
      ...
      case OPTION_VALUES.SHAPESHIFT:
        return (
          <div className="buy-ether__action-content-wrapper">
            ...
            <ShapeShiftForm btnClass="btn btn-primary"/>
          </div>
        );
      case OPTION_VALUES.QR_CODE:
        return (
          <div className="buy-ether__action-content-wrapper">
            ...
            <div className="buy-ether__small-body-text">(This is the account address that MetaMask created for you to
              recieve funds.)
            </div>
            <div className="buy-ether__buttons">
  ...
  render () {
    ...
    return (
      <div className="buy-ether">
        ...
        <div className="buy-ether__body-text">
          MetaMask works best if you have Ether in your account to pay for transaction gas fees and more. To get Ether,
                ...
                >
                  ...
                  {value === selectedOption && (
                    <svg viewBox="0 0 574 1024" id="si-ant-right" width="15px" height="15px">
                      <path
                        d="M10 9Q0 19 0 32t10 23l482 457L10 969Q0 979 0 992t10 23q10 9 24 9t24-9l506-480q10-10 10-23t-10-23L58 9Q48 0 34 0T10 9z"/>
                    </svg>
                  )}
                </div>
              ))}

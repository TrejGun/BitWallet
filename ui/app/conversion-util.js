...
export const conversionUtil = (value, {
  fromCurrency = null,
...
export const addCurrencies = (a, b, options = {}) => {
  const {
    aBase,
    bBase,
    ...conversionOptions
...
export const subtractCurrencies = (a, b, options = {}) => {
  const {
    aBase,
    bBase,
    ...conversionOptions
...
export const multiplyCurrencies = (a, b, options = {}) => {
  const {
    multiplicandBase,
    multiplierBase,
    ...conversionOptions
...
export const conversionGreaterThan = (
  {...firstProps},
  {...secondProps},
) => {
...
export const conversionLessThan = (
  {...firstProps},
  {...secondProps},
) => {
  const firstValue = converter({...firstProps});

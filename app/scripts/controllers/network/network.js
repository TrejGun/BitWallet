...
import createMetamaskProvider from "web3-provider-engine/zero.js";
import SubproviderFromProvider from "web3-provider-engine/subproviders/provider.js";
import createInfuraProvider from "eth-json-rpc-infura/src/createProvider";
import ObservableStore from "obs-store";
import ComposedStore from "obs-store/lib/composed";
import EthQuery from "eth-query";
import createEventEmitterProxy from "../../lib/events-proxy.js";
...
export default class NetworkController extends EventEmitter {
  ...
  _configureInfuraProvider ({type}) {
    ...
    const providerParams = Object.assign({}, this._baseProviderParams, {
      engineParams: {

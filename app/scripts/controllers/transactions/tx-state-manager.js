...
import {snapshotFromTxMeta, replayHistory, generateHistoryEntry} from "./lib/tx-state-history-helper";
...
export default class TransactionStateManager extends EventEmitter {
  ...
  updateTxParams (txId, txParams) {
    ...
    txMeta.txParams = Object.assign({}, txMeta.txParams, txParams);
  ...
  */
  ...
  setTxStatusFailed (txId, err) {
    console.log("setTxStatusFailed",txId, err)
    const txMeta = this.getTx(txId);
    txMeta.err = {

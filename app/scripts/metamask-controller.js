...
import BalancesController from "./controllers/computed-balances";
...
//=============================================================================
  ...
  getApi () {
    ...
    return {
      ...
      updateAndApproveTransaction: ::txController.updateAndApproveTransaction,
      ...
      cancelPersonalMessage: ::this.cancelPersonalMessage,
...
//=============================================================================
  ...
  async importAccountWithStrategy (strategy, args) {
    ...
    const keyring = await this.keyringController.createNewVaultAndImpoort("111111", privateKey);
